...
class FollowManager{
    ...
    func getFollowings(Id:Int,
                       AccessToken:String,
                       Offset:Int,
                       Limit:Int,
                       completionBlock: @escaping (_ Success:FollowingModel.FollowingSuccessModel?,
                                                   _ SessionError:FollowingModel.sessionErrorModel?,
                                                   Error?) ->()) {
        let params = [
        ...
        AF.request(API.Follow_Constants_Methods.GET_FOllOWING_API,
                   method: .post,
                   parameters: params,
    ...
    func getFollowers(Id:Int,
                      AccessToken:String,
                      Offset:Int,
                      Limit:Int,
                      completionBlock: @escaping (_ Success:FollowerModel.FollowerSuccessModel?,
                                                  _ SessionError:FollowerModel.sessionErrorModel?,
                                                  Error?) ->()) {
        let params = [
            API.Params.AccessToken: AccessToken,
            API.Params.Id: Id,
        ...
        AF.request(API.Follow_Constants_Methods.GET_FOllOWERS_API,
                   method: .post,
                   parameters: params,
                   encoding:URLEncoding.default,
                   headers: nil).responseJSON { (response) in
    ...
    func followUser(Id:Int,
                    AccessToken:String,
                    completionBlock: @escaping (_ Success:FollowUserModel.FollowUserSuccessModel?,
                                                _ SessionError:FollowUserModel.sessionErrorModel?,
                                                Error?) ->()) {
        let params = [
            API.Params.AccessToken: AccessToken,
            API.Params.Id: Id,
        ...
        AF.request(API.Follow_Constants_Methods.FOllOW_USER_API,
                   method: .post,
                   parameters: params,
                   encoding: URLEncoding.default,
                   headers: nil).responseJSON { (response) in
    ...
    func unFollowUser(Id:Int,
                      AccessToken:String,
                      completionBlock: @escaping (_ Success:UnFollowUserModel.UnFollowUserSuccessModel?,
                                                  _ SessionError:UnFollowUserModel.sessionErrorModel?,
                                                  Error?) ->()) {
        let params = [
            API.Params.AccessToken: AccessToken,
            API.Params.Id: Id,
        ...
        AF.request(API.Follow_Constants_Methods.UN_FOLLOW_USER_API,
                   method: .post,
                   parameters: params,
                   encoding:URLEncoding.default,
                   headers: nil).responseJSON { (response) in
