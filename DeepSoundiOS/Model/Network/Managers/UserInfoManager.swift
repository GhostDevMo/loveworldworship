...
class UserInforManager{
    ...
    func getUserInfo(UserId:Int,AccessToken:String,Fetch_String:String,completionBlock: @escaping (_ Success:UserInfoModel.UserInfoSuccessModel?,_ SessionError:UserInfoModel.sessionErrorModel?, Error?) ->()){
        let params = [
