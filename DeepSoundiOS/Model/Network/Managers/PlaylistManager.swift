...
class PlaylistManager {
    ...
    func getPublicPlayList(AccessToken:String,
                           Limit:Int,
                           Offset:Int,
                           completionBlock: @escaping (_ Success:PublicPlaylistModel.PublicPlaylistSuccessModel?,
                                                       _ SessionError:PublicPlaylistModel.sessionErrorModel?,
                                                       Error?) ->()) {
        let params = [
        ...
        AF.request(API.Playlist_Constants_Methods.GET_PUBLIC_PLAYLIST_API,
                   method: .post,
                   parameters: params,
    ...
    func getPlayList(UserId:Int,
                     AccessToken:String,
                     Limit:Int,
                     Offset:Int,
                     completionBlock: @escaping (_ Success:PlaylistModel.PlaylistSuccessModel?,
                                                 _ SessionError:PlaylistModel.sessionErrorModel?,
                                                 Error?) ->()) {
        let params = [
            API.Params.AccessToken: AccessToken,
        ...
        AF.request(API.Playlist_Constants_Methods.GET_PLAYLIST_API,
                   method: .post,
                   parameters: params,
                   encoding: URLEncoding.default,
                   headers: nil).responseJSON { (response) in
    ...
    func getPlayListSongs(playlistId:Int,
                          AccessToken:String,
                          completionBlock: @escaping (_ Success:GetPlaylistSongsModel.GetPlaylistSongsSuccessModel?,
                                                      _ SessionError:GetPlaylistSongsModel.sessionErrorModel?,
                                                      Error?) ->()) {
        let params = [
            API.Params.AccessToken: AccessToken,
        ...
        AF.request(API.Playlist_Constants_Methods.GET_PLAYLIST_SONGS_API,
                   method: .post,
                   parameters: params,
                   encoding: URLEncoding.default,
                   headers: nil).responseJSON { (response) in
    ...
    func updatePlaylist(PlaylistId:Int,
                        AccesToken: String,
                        Name:String,
                        Privacy:Int,
                        Thumbnail_data:Data?,
                        completionBlock: @escaping (_ Success:UpdatePlaylistModel.UpdatePlaylistSuccessModel?,
                                                    _ sessionError:UpdatePlaylistModel.sessionErrorModel?,
                                                    Error?) ->()) {
        let params = [
        ...
        }, to: API.Playlist_Constants_Methods.UPDATE_PLAYLIST_API,
    ...
    func createPlaylist(userId: Int, AccesToken: String, Name: String, Privacy: Int, Thumbnail_data: Data?, completionBlock: @escaping(_ Success: CreatePlaylistModel?, _ sessionError: BaseModel.sessionErrorModel?, Error?) -> () ) {
        let params = [
            API.Params.AccessToken : AccesToken,
            API.Params.Id : userId,
            API.Params.Name : Name,
        ...
        AF.upload(multipartFormData: { (multipartFormData) in
            ...
            if let res = response.value as? [String: Any] {
                ...
                if apiStatus == API.ERROR_CODES.E_TwoH {
                    ...
                    let result = try! JSONDecoder().decode(CreatePlaylistModel.self, from: data)
                    completionBlock(result, nil, nil)
                } else {
    ...
    func deletePlaylist(playlistId:Int,
                        AccessToken:String,
                        completionBlock: @escaping (_ Success:DeletePlaylistModel.DeletePlaylistSuccessModel?,
                                                    _ SessionError:DeletePlaylistModel.sessionErrorModel?,
                                                    Error?) ->()) {
        let params = [
            API.Params.AccessToken: AccessToken,
            API.Params.Id: playlistId,
        ...
        AF.request(API.Playlist_Constants_Methods.DELETE_PLAYLIST_API,
                   method: .post,
                   parameters: params,
                   encoding: URLEncoding.default,
                   headers: nil).responseJSON { (response) in
    ...
    func addToPlaylist(trackId:Int,
                       AccessToken:String,
                       PlaylistIdString:Int,
                       completionBlock: @escaping (_ Success:AddToPlaylistModel.AddToPlaylistSuccessModel?,
                                                   _ SessionError:AddToPlaylistModel.sessionErrorModel?,
                                                   Error?) ->()) {
        let params = [
            API.Params.AccessToken: AccessToken,
        ...
        AF.request(API.Playlist_Constants_Methods.ADD_TO_PLAYLIST_API,
                   method: .post,
                   parameters: params,
                   encoding: URLEncoding.default,
                   headers: nil).responseJSON { (response) in
