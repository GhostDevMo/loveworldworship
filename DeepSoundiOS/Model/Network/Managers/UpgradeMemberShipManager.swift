...
class UpgradeMemberShipManager{
    ...
    func upgradeMemberShip(userId:Int,
                           AccessToken:String,
                           completionBlock: @escaping (_ Success: UpgradeMemberShipModel.UpgradeMemberShipSuccessModel?,
                                                       _ SessionError: UpgradeMemberShipModel.sessionErrorModel?,
                                                       Error?) ->()) {
        let params = [
        ...
        AF.request(API.Upgrade_MemberShip_Methods.UPGRADE_MEMBERSHIP_API,
                   method: .post,
                   parameters: params,
    ...
    func purchase(AccessToken:String,
                  type:String,
    ...
    func purchaseAlbum(AccessToken:String,
                       type:String,
                       AlbumID:String,
                       completionBlock: @escaping (_ Success:String?,
                                                   _ SessionError:String?,
        ...
        AF.request(API.Purchase.GO_PRO,
                   method: .post,
                   parameters: params,
                   encoding: URLEncoding.default,
                   headers: nil).responseJSON { (response) in
