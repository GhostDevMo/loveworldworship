...
class PurchaseTrackManager{
    ...
    func purchaseTrack(AccessToken:String,userId:Int,TrackId:Int,completionBlock: @escaping (_ Success:PurchaseTrackModel.PurchaseTrackSuccessModel?,_ SessionError:PurchaseTrackModel.sessionErrorModel?, Error?) ->()){
        let params = [
        ...
        AF.request(API.Purchase_Track_Methods.PURCHASE_TRACK_API, method: .post, parameters: params, encoding:URLEncoding.default , headers: nil).responseJSON { (response) in
