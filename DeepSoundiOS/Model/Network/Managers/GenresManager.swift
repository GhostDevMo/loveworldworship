...
class GenresManager{
    ...
    func getGenres(AccessToken:String,
                   completionBlock: @escaping (_ Success:GenresModel.GenresSuccessModel?,
                                               _ SessionError:GenresModel.sessionErrorModel?,
                                               Error?) ->()) {
        let params = [
        ...
        AF.request(API.GetGenres_Constants_Methods.GET_GENRES_API,
                   method: .post,
                   parameters: params,
    ...
    func updateGenres(AccessToken:String,
                      Id:Int,
                      Genres:String,
                      completionBlock: @escaping (_ Success:UpdateInterestModel.UpdateInterestSuccessModel?,
                                                  _ SessionError:UpdateInterestModel.sessionErrorModel?,
                                                  Error?) ->()) {
        let params = [
            API.Params.AccessToken: AccessToken,
            API.Params.Id: Id,
        ...
        AF.request(API.GetGenres_Constants_Methods.UPDATE_GENRES_API,
                   method: .post,
                   parameters: params,
                   encoding:URLEncoding.default,
                   headers: nil).responseJSON { (response) in
