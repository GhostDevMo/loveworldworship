...
class BlockUsersManager{
    ...
    func getBlockUsers(Id:Int,
                       AccessToken:String,
                       Offset:Int,
                       Limit:Int,
                       completionBlock: @escaping (_ Success:GetBlockUsersModel.GetBlockUsersSuccessModel?,
                                                   _ SessionError:GetBlockUsersModel.sessionErrorModel?,
                                                   Error?) ->()) {
        let params = [
    ...
    func unBlockUser(Id:Int,
                     AccessToken:String,
                     completionBlock: @escaping (_ Success:UnblockUserModel.UnblockUserSuccessModel?,
                                                 _ SessionError:UnblockUserModel.sessionErrorModel?,
                                                 Error?) ->()) {
        let params = [
            API.Params.AccessToken: AccessToken,
            API.Params.Id: Id,
        ...
        AF.request(API.BlockUsers_Constants_Methods.UN_BLOCK_USER_API,
                   method: .post,
                   parameters: params,
    ...
    func blockUser(Id:Int,
                   AccessToken:String,
                   completionBlock: @escaping (_ Success:blockUserModel.blockUserSuccessModel?,
                                               _ SessionError:blockUserModel.sessionErrorModel?,
                                               Error?) ->()) {
        let params = [
            API.Params.AccessToken: AccessToken,
            API.Params.Id: Id,
        ...
        AF.request(API.BlockUsers_Constants_Methods.BLOCK_USER_API,
                   method: .post,
                   parameters: params,
                   encoding:URLEncoding.default,
                   headers: nil).responseJSON { (response) in
