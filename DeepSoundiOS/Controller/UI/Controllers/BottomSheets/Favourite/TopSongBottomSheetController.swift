...
class TopSongBottomSheetController: UIViewController, PanModalPresentable{
    ...
    var latestSong:TrendingModel.TopSong
    ...
    override func viewDidLoad() {
        ...
        self.lblSongDuration.text = latestSong.topSongDescription
    ...
    init(song: TrendingModel.TopSong) {
        latestSong = song
