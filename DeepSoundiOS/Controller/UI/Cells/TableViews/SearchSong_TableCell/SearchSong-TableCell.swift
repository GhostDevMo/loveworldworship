...
import Async
import DeepSoundSDK
class SearchSong_TableCell: UITableViewCell {
    ...
    var audioId:String? = ""
    var vc:SearchSongsVC?
    var userId:Int? = 0
    var object : SearchModel.Song?
    ...
    func bind(_ object:SearchModel.Song, index :Int){
