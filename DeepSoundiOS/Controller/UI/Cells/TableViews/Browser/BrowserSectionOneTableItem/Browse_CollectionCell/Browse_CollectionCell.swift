...
class Browse_CollectionCell: UICollectionViewCell {
    ...
    func bind(_  object :TrendingModel.TopSong){
        ...
        nameLabel.text = "\(object.categoryName?.htmlAttributedString ?? "") \(NSLocalizedString("Music", comment: "Music"))"
