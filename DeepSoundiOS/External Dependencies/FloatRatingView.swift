...
open class FloatRatingView: UIView {
    ...
    @IBInspectable open var editable = false
    ...
    override open func layoutSubviews() {
        ...
        let maxImageWidth = 20//max(minImageSize.width, desiredImageWidth)
        let maxImageHeight = 20//max(minImageSize.height, frame.size.height)
