...
/// `CreditCardType3` is the credit card type name, used to name specific
/// real-life card type
@objc public enum CreditCardType3: Int {
    ...
    var image: UIImage? {
        ...
        case .NotRecognized, .UnionPay, .JCB, .Discover, .Dankort, .DinersClub:
            return UIImage(named: "ic_no_credit_card")
        default:
            return UIImage(named: "ic_no_credit_card")
        }
    }
...
public class CCValidator: NSObject {
    ...
    public convenience init(type: CreditCardType3) {
        // default specs
...
public extension CCValidator {
    ...
    private class func possibleTypesCheckingLengthOnly(creditCardNumber number: String) -> [CreditCardType3] {
        let allTypes = self.allTypes()
        var possibleTypes: [CreditCardType3] = []
    ...
    private class func allTypes() -> [CreditCardType3] {
        return [
            .AmericanExpress,
            .Dankort,
            .DinersClub,
    ...
    class func typeCheckingPrefixOnly(creditCardNumber number: String) -> CreditCardType3 {
    ...
    /// - Returns: Credit Card Type, or `.NotRecognized` if failed to recognize the type
    class func typeCheckingPrefixOnly(creditCardNumber number: String, checkOnlyFromTypes types:[CreditCardType3]) -> CreditCardType3 {
        var type: CreditCardType3 = .NotRecognized
