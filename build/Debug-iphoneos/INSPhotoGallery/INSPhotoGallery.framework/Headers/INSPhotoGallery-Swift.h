...
#ifndef INSPHOTOGALLERY_SWIFT_H
#define INSPHOTOGALLERY_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="INSPhotoGallery",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
SWIFT_CLASS("_TtC15INSPhotoGallery28INSPhotosInteractionAnimator")
@interface INSPhotosInteractionAnimator : NSObject <UIViewControllerInteractiveTransitioning>
...
SWIFT_CLASS("_TtC15INSPhotoGallery27INSPhotosTransitionAnimator")
@interface INSPhotosTransitionAnimator : NSObject <UIViewControllerAnimatedTransitioning>
